...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(7,'AngioBaseA','userinfo'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(6,'sessions','session'),(15,'user','answertable'),(22,'user','betainfo'),(12,'user','comment'),(16,'user','examrecord'),(13,'user','img'),(11,'user','leave_message'),(8,'user','notice'),(20,'user','pictureurl'),(21,'user','picturnameandeurl'),(14,'user','question'),(19,'user','questionex'),(18,'user','questiongif'),(17,'user','questions'),(10,'user','userform'),(9,'user','views_count');
...
INSERT INTO `user_answertable` VALUES (1,'Myocardial bridge111','0',1),(2,'Anomalous left coronary artery off of the pulmonary artery','1',1),(3,'Anomalous left coronary artery off of the descending thoracic aorta','0',1),(4,'Anomalous left coronary artery off of the bronchial artery','0',1),(5,'Hypertrophic cardiomyopathy','0',1),(6,'Left; LAD; AV nodal','0',2),(7,'Left; LAD; atrial','0',2),(8,'Left; LCx; AV nodal','1',2),(9,'Left; LCx; atrial','0',2),(10,'Right; RCA; AV nodal','0',2),(11,'Trabeculation; LAD','0',3),(12,'Trabeculation; LCx','0',3),(13,'Critical stenosis; LAD','0',3),(14,'Myocardial bridge; LAD','1',3),(15,'Myocardial bridge; LCx','0',3);
...
INSERT INTO `user_betainfo` VALUES (35,'qgfgggdddd','zzxz','Medical Student','2394470381@qq.com'),(36,'qgfgggdddd','aaa','Medical Student','2394470381@qq.com'),(37,'qgfggg','aaaaa','Subspecialty','6666666666@qq.com');
...
INSERT INTO `user_leave_message` VALUES (1,'first','This is the first message, please...','2022-02-09 04:53:59.171985','2022-02-09 04:53:59.171985','1',1),(2,'second','This is the second message, please...','2022-02-09 05:33:24.876681','2022-02-09 05:33:24.876681','1',1),(3,'test','test vessel','2022-02-09 11:17:46.068188','2022-02-09 11:17:46.068188','1',1),(7,'1','1','2022-02-16 08:03:26.213526','2022-02-16 08:03:26.213526','1',1);
...
INSERT INTO `user_notice` VALUES (1,'TEST1','TEST1','1','2022-02-08 12:18:57.252517',0),(2,'TEST2','TEST2','1','2022-02-08 12:19:11.729417',1),(3,'TEST3','TEST3','1','2022-02-08 12:19:18.451397',3),(4,'TEST4','TEST4','1','2022-02-08 12:19:23.617354',3),(5,'TEST5','TEST5','1','2022-02-08 12:19:29.404314',6),(6,'Subsequent development','Subsequent development','1','2022-02-08 12:19:34.203593',2),(7,'System Introduction','The site was created to help users quickly identify coronary vessels in ICA images. \nTwo methods are provided in the Vessel Identification module for users to use.','1','2022-02-08 12:19:39.397182',12),(8,'ICA Introduction','Invasive coronary angiography (ICA) is considered the reference standard, \nparticularly when combined with hemodynamic interrogation by fractional flow reserve (FFR) \nin the presence of an intermediate coronary lesion (ie, 30%–90% diameter stenosis).','1','2022-02-09 05:26:07.048749',22);
...
INSERT INTO `user_question` VALUES (1,'57 year-old woman presents with shortness of breath. What is the diagnosis?','Anomalous left coronary from the pulmonary artery (ALCAPA), also known as Bland-White-Garland syndrome, is a rare congenital anomaly that affects less than 1% of live births. Most of these children do not survive to adulthood. These patients are at risk f','1. Angelini P, Velasco JA, Flamm S. Coronary anomalies: incidence, pathophysiology, and clinical relevance. Circulation. 2002 May 21;105(20):2449-54. 2. Parizek P, Haman L, Harrer J, Tauchman M, Rozsival V, Varvarovsky I, Pleskot M, Mestan M, Stasek J. Bl','1'),(2,'This coronary circulation is ___ dominant. You can tell because the ___  gives off the ___ artery.','Dominance is determined by which coronary (RCA vs LCx) gives rise to the posterior descending artery, which in turn gives off the AV nodal artery. In this case, the coronary tree is left-dominant. The AV nodal artery is highlighted, originating from the L','1. Angelini P, Velasco JA, Flamm S. Coronary anomalies: incidence, pathophysiology, and clinical relevance. Circulation. 2002 May 21;105(20):2449-54. 2. Parizek P, Haman L, Harrer J, Tauchman M, Rozsival V, Varvarovsky I, Pleskot M, Mestan M, Stasek J. Bl','1'),(3,'This is an example of a ___ in the ___ artery.','A myocardial bridge, characterized by an intramyocardial segment of an epicardial coronary artery, is suggested here by the systolic compression of the  tunneled segment. In most cases, this anomaly remains clinically silent. ','1. Möhlenkamp S, Hort W, Ge J, Erbel R. Update on myocardial bridging. Circulation. 2002 Nov 12;106(20):2616-22. ','1');
...
INSERT INTO `user_views_count` VALUES (1,'2022-09-03 03:11:04.528832',7,1),(2,'2022-09-03 03:11:08.291446',6,1),(3,'2022-02-09 13:05:29.928361',4,1),(4,'2022-02-08 20:26:52.149880',2,1),(5,'2022-09-10 21:11:38.664673',3,1),(6,'2022-09-03 03:11:13.831501',5,1),(7,'2023-02-25 21:24:38.620896',8,1),(8,'2022-02-09 17:44:16.347334',8,3),(9,'2022-02-16 16:55:06.032492',8,9),(10,'2022-03-13 17:37:38.185066',5,12);
...
-- Dump completed on 2023-02-25 23:09:03
